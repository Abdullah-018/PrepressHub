...
> **v1.0 থেকে আপডেট করলে:** নতুন project তৈরি বা `001_schema_and_security.sql` পুনরায় চালানোর প্রয়োজন নেই। আগে database backup নিন, তারপর SQL Editor-এ `supabase/005_security_and_integrity_upgrade.sql` এবং শেষে `supabase/004_verify_setup.sql` চালান। পুরোনো self-declared company domain মুছে যাবে; company proof যাচাই করে Admin dashboard থেকে domain আবার সেট করতে হবে।
